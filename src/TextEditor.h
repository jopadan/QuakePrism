...
class TextEditor {
  public:
	...
	// from 0. Tabs are counted as [1..mTabSize] count empty spaces, depending
	// on how many space is necessary to reach the next tab stop. For example,
	// coordinate (1, 5) represents the character 'B' in a line "\tABC", when
	// mTabSize = 4, because it is rendered as "    ABC" on the screen.
	struct Coordinates {
		int mLine, mColumn;
	...
	struct LanguageDefinition {
		...
		static const LanguageDefinition &QuakeC();
